    ...
    <main className="container mx-auto px-4 py-16 max-w-3xl min-h-[60vh]">
      ...
      <div className="prose prose-gray max-w-none space-y-6">
        ...
        <section>
          ...
          <p>
            {agencyName} collects personal information that you provide when making a booking,
            contacting us, or subscribing to our newsletter. This may include your name, email
            address, phone number, payment details, and travel preferences.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            We use your information to process bookings, communicate about your travel plans,
            improve our services, and send promotional offers (only with your consent). We do not
        ...
        <section>
          ...
          <p>
            We may share your information with trusted service providers (hotels, airlines, tour
            operators) solely to fulfil your bookings. We also use secure payment processors to
            handle transactions.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            {agencyName} employs industry-standard security measures to protect your personal
            information, including encrypted connections (TLS/SSL) and secure data storage.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            exercise these rights, please contact us via our{' '}
        ...
        <section>
          ...
          <p>
            {agencyName} may update this Privacy Policy periodically. We will notify you of
