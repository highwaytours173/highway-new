...
export default function UpsellItemEditClient({ initialData, onSubmit }: UpsellItemEditClientProps) {
  return <UpsellItemForm initialData={initialData} onSubmit={onSubmit} formType="edit" />;
}
